  ...
  function initNavbarAuth() {
    ...
    if (actionsEl) {
      if (user) {
        ...
        // Apply i18n to newly injected navbar elements
        setTimeout(() => { if (window.CineI18n) CineI18n.apply(); }, 10);
        // Inject notification bell
        setTimeout(() => { if (window.CineNotif) CineNotif.injectBell(); }, 50);
      ...
      <div class="navbar__user-menu" id="user-menu">
        ...
        <div class="navbar__user-dropdown" id="user-dropdown" aria-hidden="true">
          ...
          <a href="${base}pages/watchlist.html" class="navbar__dropdown-item">
            ...
            <span data-i18n="nav.watchlist">Watchlist Saya</span>
          </a>
          <a href="${base}pages/history.html" class="navbar__dropdown-item">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
            <span data-i18n="nav.history">Riwayat Tontonan</span>
          </a>
          ...
          <a href="${base}pages/stats.html" class="navbar__dropdown-item">
            ...
            <span data-i18n="nav.stats">Statistik Saya</span>
          </a>
          <div class="navbar__dropdown-divider"></div>
